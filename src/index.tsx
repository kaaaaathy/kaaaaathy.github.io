  ...
  return (
    <section className="inner">
      <h2>
        ...
        <li>HYPERTEXT</li>
        <p id="credit">The work here is deeply inspired by and rooted in the ideas + teachings of Kameelah Janan Rasheed, Allison Parrish, Marisa Morán Jahn, Pauline Oliveros, Eunsong Kim, Blair Simmons, Sawako Nakayasu, Maralie Armstrong-Rial, Eleni Sikelianos, Renee Gladman, many others...
          ...
          <br /><br />Drawing circa 1999. Website designed by kw, with development credit to Lily Wu.
          <br /> Set in Authentic Sans, HB Lossy, FT88.</p>
      </h2 >
    </section >
  )
}
