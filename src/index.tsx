    ...
    <section className="inner">
      <h2>
        ...
        worked on < a href="https://www.media.mit.edu/projects/scratch/overview/" target="_blank" > creative
          tools</a > at MIT. She has been published or anthologized by < a href="https://parsonsdt.github.io/critical-coding-cookbook/" target="_blank" > The New School</a >, Fonograf Editions, Nightboat Books, <a href="https://www.natbrut.org/issue-eighteen" target="_blank">NatBrut</a>, <a href="https://www.tiltedhouse.org/shop/for-let-earth-kathy-wu-presale" target="_blank">Tilted House</a>, and selected for art/writing residencies at the <a href='centerforbookarts.org' target="_blank">Center for Book Arts</a>, Bread Loaf Writer's Conference, Provincetown Fine Arts Work Center, Blue Mountain Center, <a href="https://www.blackmountaincollege.org/" target="_blank">Black Mountain College Museum + Art Center</a>. Their visual art + performance work has been shown at SoMad Gallery, <a href="https://www.culturehub.org/events/into-uncertain-weathers" target="_blank">CultureHub & La MaMa</a>, Emerson Contemporary, Ulises Project Space, AS220, Pao Arts Center. They have given talks at <a href="https://amc.alliedmedia.org/" target="_blank">Allied Media Conference</a>, American Association for Geographers, WordHack, and other places. She is learning to move more slowly.
